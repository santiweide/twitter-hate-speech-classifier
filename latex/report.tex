...
\begin{itemize}
    ...
    \item \textbf{Efficiency:} Here resource computation efficiency is focused, and the metrics are latency is analyzed by torch profile. Only inference time efficiency is analyzed due to time limit.
 \end{itemize}
